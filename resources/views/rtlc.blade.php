        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                newData.forEach(function (item, index) {
                    ...
                    lineChart.data.datasets[2].data.push(item.people_with_mask); // Replace 'anotherDataSetValue' with your second dataset value
                    lineChart.data.datasets[1].data.push(item.people_without_mask); // Replace 'yetAnotherDataSetValue' with your third dataset value
                });
